...
public struct IONCAMRFactory {
    ...
    public static func createCameraManagerWrapper(withDelegate delegate: IONCAMRCallbackDelegate, and viewController: UIViewController) -> IONCAMRCameraActionDelegate {
